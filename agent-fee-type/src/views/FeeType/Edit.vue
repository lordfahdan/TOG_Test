...
export default {
  ...
  methods: {
    ...mapActions(useFeeStore, ['editFee', 'detailFee']),
    editingFee(name, desc, fee_code){
      ...
      const obj = {name, desc, fee_code}
      this.editFee(obj).then((e) => {
        Swal.fire({
          title: 'Success!',
          text: e,
          icon: 'success',
...
<template>
  <div>
    ...
    <h1>Edit Fee Type</h1>
    <form @submit.prevent="editingFee(name, desc, id)">
      <div class="card-form">
        <div class="fee-form">
